...
export default function Home_Page() {
  return (
    <section className="flex max-sm:flex-col-reverse items-center justify-around max-sm:justify-center max-sm:gap-24 px-10 max-sm:px-2 mb-12 min-h-[80vh] snap-center" id="home">
